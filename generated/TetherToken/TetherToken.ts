...
export class NewTetherToken extends ethereum.Event {
  get params(): NewTetherToken__Params {
    return new NewTetherToken__Params(this);
  }
}

export class NewTetherToken__Params {
  _event: NewTetherToken;

  constructor(event: NewTetherToken) {
    this._event = event;
  }
...
export class TetherTokenTransfer extends ethereum.Event {
  get params(): TetherTokenTransfer__Params {
    return new TetherTokenTransfer__Params(this);
  }
}

export class TetherTokenTransfer__Params {
  _event: TetherTokenTransfer;

  constructor(event: TetherTokenTransfer) {
    this._event = event;
  }
